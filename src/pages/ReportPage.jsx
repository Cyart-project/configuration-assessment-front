        ...
        <CardContent className="pt-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <p className="text-gray-700">
              <strong>IP Address:</strong> {deviceInfo.IP || "N/A"}
            </p>
            <p className="text-gray-700">
              <strong>Last Scan:</strong> {deviceInfo.lastScan || "N/A"}
            </p>
            <p className="text-gray-700">
              <strong>OS:</strong> {deviceInfo.os || "N/A"}
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="shadow-md rounded-lg border border-gray-200">
        ...
        <CardContent className="pt-6">
          {remediationData.map((item, index) => (
            <div
              key={index}
              className="mb-6 p-4 bg-white shadow-sm rounded-lg border border-gray-200"
            >
              ...
              <p className="text-gray-600 mt-1">
                <strong>Related CVE:</strong> {item.cveId}
              </p>
              <p className="text-gray-600 mt-1">
